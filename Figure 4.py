...
line2 = cur_ax.semilogy(t[2:],1 / (DeterIV**2) * SamplingVar_analytical[0] * (DeterIV[0]**2),color=Palette[7],linewidth=lw,zorder=0,linestyle='--',label='Scaled $V^{-2}$')
...
if save_flag:
    plt.savefig('./Figures/Fig4_EstMeanVarSto.jpg',dpi=dpi_val,bbox_inches='tight')