# -*- coding: utf-8 -*-
"""
Estimator mean and variance with different values of population sizes,
...
for set_idx,thisSet in enumerate(Sets):
    ...
    cur_ax.text(0.05,0.91,'$N = $' + str(N),fontsize=FontSize,ha='left',va='center',transform=cur_ax.transAxes)
...
if save_flag:
    plt.savefig('./Figures/SuppFig5_EstMeanVarSto_N.pdf',dpi=dpi_val,bbox_inches='tight')